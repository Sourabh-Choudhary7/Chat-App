...
import { createGroupChat, exitGroup, fetchGroups, getGroupChat, getOrCreateChat, makeGroupAdmin } from "../controllers/chat.controller.js";
...
router.get('/get-groups', isLoggedIn, fetchGroups);
